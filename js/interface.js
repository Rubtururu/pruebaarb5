var minersAddr = '0xB2Ac1b29787B579E9b1Df2A89A4a0D0BD5DEC1eF';
var tokenAddr = '0x912CE59144191C1204E64559FE8253a0e49E6548';
var minersAbi =
[
	{
		"constant": true,
...
function buyEggs(ref, trx, callback){
	if(+trx > +usrBal) {
		alert("You don't have " + trx + " ARB in your wallet");
	}
	else if(+trx > +spend) {
		alert("Approve spending " + trx + " ARB first");
	} else {
